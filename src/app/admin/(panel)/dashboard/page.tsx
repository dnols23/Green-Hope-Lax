...
import { getViewer, canSee, requireSection } from '@/lib/permissions'
...
/**
 * The site's numbers: signups waiting, messages in, what is published.
 *
 * Off the front door on purpose — signing in puts every coach in the War Room,
 * because a coach signs in to coach. This is the other job, and it is in the
 * menu when you want it.
 */
