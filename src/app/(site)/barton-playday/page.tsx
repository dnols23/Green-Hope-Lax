...
const FACTS = [
  ...
  { label: 'Where', value: 'Barton College', desc: 'Wilson, NC' },
      ...
      <section className="hero-gradient text-white">
        <div className="max-w-screen-xl mx-auto px-4 py-14 sm:py-20 text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-white/75">
            ...
            morning games. Sign up below and we will send the schedule the moment it is out.
          </p>
          ...
          {accepting ? (
            <>
              <p className="text-gray-600 mb-6">
                ...
                Venmo. Coaches follow up with the schedule and travel plan.
              </p>
              <EventSignupForm
                event={KEY}
