    ...
    <div className="flex flex-col min-h-svh" style={{ background: '#0b0d0c' }}>
      ...
      >
        <div className="px-4 h-14 flex items-center justify-between">
          <Link href="/team/video" className="flex items-center gap-2.5">
            <span className="inline-flex items-center justify-center bg-white rounded-lg px-1.5 py-1">
              <FalconHead size={24} />
            </span>
            <span className="flex flex-col leading-none">
              <span className="font-black">Library</span>
              <span className="text-[0.6rem] tracking-widest" style={{ color: '#18b877' }}>
                FILM ROOM
              </span>
            </span>
          </Link>
          <Link href="/team/video" className="text-xs hover:text-white" style={{ color: '#9aa39d' }}>
            ← Board
          </Link>
        </div>
      </header>
