      ...
      <div className="max-w-screen-xl mx-auto px-4 py-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href={SCHOOL.maxprepsBoys} target="_blank" rel="noopener noreferrer" className="hover:text-white">MaxPreps (Boys) ↗</a></li>
            <li><a href={SCHOOL.maxprepsGirls} target="_blank" rel="noopener noreferrer" className="hover:text-white">MaxPreps (Girls) ↗</a></li>
          </ul>
        </div>
